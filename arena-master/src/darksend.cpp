...
{
    if(fLiteMode) return; // ignore all Arena related functionality
...
/*
    ...
    allow endless transaction that would bloat Arena and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("arena-privatesend");
