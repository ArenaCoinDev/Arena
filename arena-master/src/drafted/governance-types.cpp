...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ArenaNetwork") type = ArenaNetwork;
    if(strType == "ArenaNetworkVariable") type = ArenaNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ArenaNetwork) s = "ArenaNetwork";
    if(type == ArenaNetworkVariable) s = "ArenaNetworkVariable";
