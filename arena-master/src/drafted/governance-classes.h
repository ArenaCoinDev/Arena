 ...
 *
 *   // network
 *   CArenaNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.arenacoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CArenaNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: ArenaNetwork
// //   -- signature requirements : Key1(User)
// class CArenaNetworkVariable : public CGovernanceObject
// {
// private:
