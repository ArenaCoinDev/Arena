...
//    sendCoinsAction = new QAction(QIcon(":/icons/" + theme + "/send"), tr("&Send"), this);
    ...
    //receive
	QPixmap receiveIconInactive(":/icons/" + theme + "/receiving_addresses");
    QPixmap receiveIconActive(":icons/" + theme + "/receiving_addresses_active");
...
//    receiveCoinsAction = new QAction(QIcon(":/icons/" + theme + "/receiving_addresses"), tr("&Receive"), this);
    ...
    if (settings.value("fShowMasternodesTab").toBool()) {
		...
		masternodeIcon.addPixmap(masternodeIconActive,QIcon::Selected,QIcon::On);
		masternodeIcon.addPixmap(masternodeIconActive,QIcon::Selected,QIcon::Off);
		masternodeIcon.addPixmap(masternodeIconActive,QIcon::Active,QIcon::On);
		masternodeIcon.addPixmap(masternodeIconActive,QIcon::Active,QIcon::Off);
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Arena Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Arena Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Arena addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Arena addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Arena Core help message to get a list with possible Arena Core command-line options"));
