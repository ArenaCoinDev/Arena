    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ARENA-light"), QVariant("light"));
    ui->theme->addItem(QString("ARENA-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ARENA-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ARENA-traditional"), QVariant("trad"));
