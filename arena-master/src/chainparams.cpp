...
// Copyright (c) 2014-2018 The Arena Core developers
...
{
    const char* pszTimestamp = "Arena starts now, let the battle begin!";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 2 * 60; // Arena: every blocks
        consensus.nPowTargetSpacing = 2 * 60; // Arena: 2 minutes
...
*/
        ...
        // Arena private keys start with 'E'
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        consensus.nPowTargetTimespan = 60 * 60; // Arena: 1 hour
        consensus.nPowTargetSpacing = 2 * 60; // Arena: 2 minutes
   ...
   //     assert(genesis.hashMerkleRoot == uint256S("0x33a98e8f8089165dc24358b01d52dd740011bdbffad052d51d3ac3588af2f487"));
        ...
        // Testnet Arena addresses start with 'R'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,61);
        // Testnet Arena script addresses start with '5'
...
public:
    CRegTestParams() {
        ...
        // Regtest Arena addresses start with 'n'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,112);
        // Regtest Arena script addresses start with '5'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,10);
        // Regtest private keys start with '5' or 'c' (Bitcoin defaults) (?)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,240);
        // Regtest Arena BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Arena BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Regtest Arena BIP44 coin type is '1' (All coin's testnet default)
        base58Prefixes[EXT_COIN_TYPE]  = boost::assign::list_of(0x80)(0x00)(0x00)(0x01).convert_to_container<std::vector<unsigned char> >();
   }
};
