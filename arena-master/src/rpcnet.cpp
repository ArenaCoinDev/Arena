...
UniValue getpeerinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"subver\": \"/Arena Core:x.x.x/\",  (string) The string version\n"
...
UniValue addnode(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2 ||
        ...
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("addnode", "\"192.168.0.6:16050\" \"onetry\"")
            + HelpExampleRpc("addnode", "\"192.168.0.6:16050\", \"onetry\"")
        );
...
UniValue getaddednodeinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "    \"addresses\" : [\n"
            "       {\n"
            "         \"address\" : \"192.168.0.201:16050\",  (string) The arena server host and port\n"
...
static UniValue GetNetworksInfo()
{
    ...
    for(int n=0; n<NET_MAX; ++n)
    {
        ...
        obj.push_back(Pair("proxy_randomize_carenatials", proxy.randomize_carenatials));
...
UniValue getnetworkinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"subversion\": \"/Arena Core:x.x.x/\", (string) the server subversion string\n"
