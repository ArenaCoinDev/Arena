/* src/config/arena-config.h.  Generated from arena-config.h.in by configure.  */
/* src/config/arena-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Arena Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Arena Core"
...
#define PACKAGE_BUGREPORT "https://github.com/NicholasAdmin/Arena/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Arena Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Arena Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "arenacore"
