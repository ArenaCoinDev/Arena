UNIX BUILD NOTES
====================
Some notes on how to build Arena Core in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

Note
---------------------
Always use absolute paths to configure and compile Arena Core and the dependencies,
...
See the section "Disable-wallet mode" to build Arena Core without wallet.
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, Arena Core should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, Arena Core may be compiled in
